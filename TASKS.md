...
- Set up Maven build and JavaFX scaffold
- Add JavaFX application entry point
- Add JUnit test scaffold
- Add GitHub workflows for SonarCloud and Snyk
- Add documentation files required by the assignment
...
- Add difficulty selection for coding questions
- Add topic selection for practise questions
- Add scoring rubrics for correctness, efficiency, communication, and code quality
